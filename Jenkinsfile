...
//                 sh 'docker run my_test1 --browser chrome'
                sh 'docker run --name my_test_85 my_test1 --url http://192.168.0.13 --executor 192.168.0.13 --browser chrome'

//                 sh 'docker cp my_test_18:/app/allure-result /var/jenkins_home/workspace/test2/allure-report'
                sh 'docker cp my_test_85:/app/allure-result /var/jenkins_home/workspace/test2/allure-results'
